...
const LoginModal = ({ onClose }) => {
  ...
  Not registered yet?{" "}
  <span className="bg-gradient-to-br from-green-400 to-white bg-clip-text text-transparent cursor-pointer">
    Register
  </span>
</p>
          <form onSubmit={handleSubmit}>
            ...
            <div className="modal-action mt-4">
              {loading ? (
                ...
                <>
                  <button type="submit" className="btn bg-orange-500 text-xl font-normal text-white hover:bg-orange-600 p-2">
                    Save
                  </button>
                  <button type="button" onClick={onClose} className="btn bg-red-500 text-xl font-normal text-white hover:bg-red-600 p-2">
                    Close
                  </button>
                </>
              )}
